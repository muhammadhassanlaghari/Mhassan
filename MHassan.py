...
def cetak(b):
    ...
    for i in w:
        j = w.index(i)
        x= x.replace('!%s'%i,'\031[%s;1m'%str(31+j))
    x += '\033[0m'
    x = x.replace('!0','\031[0m')
    sys.stdout.write(x+'\n')
...
logo = """
    ...
    \031[1;94m::▒▒▒▒▒▒█▒▒▒█▒█▒█▒▒▒█▒█▒▒▒▒▒▒▒▒▒▒::::      
   \031[1;95m:::▒▒▒▒▒▒███▒███▒███▒███▒▒▒▒▒▒▒▒▒▒:::::         
  \031[1;96m::♧♧♧♧♧♧♧♧♧♧\031[1;91mWhatsapp\031[1;96m♧♧♧♧♧♧♧♧♧♧▒▒▒▒▒▒▒::::        
  \031[1;91m:》》》\033[1;93m+92183319095\031[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\031[1;95m♡╭──────────•◈•──────────╮♡\031[1;96m-M Hassan-\031[1;95m♡╭──────────•◈•──────────╮♡
\031[1;92m..........................M Hassan......................
\031[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\031[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   Awais Ahmed 
\031[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\031[1;95m♡╰──────────•◈•──────────╯♡\031[1;96mM Hassan\031[1;95m♡╰──────────•◈•──────────╯♡"""
...
print  """
 ...
 \031[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \031[1;96m ─────────────•◈•──────────  
   \031[1;92m███████▒▒Welcome To M Hassan▒▒████████
\031[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mBlackMafia\033[1;95m♡╭──────────•◈•──────────╮♡
\031[1;94mAuthor\033[1;91m: \033[1;91fromDadLaghari
\031[1;94mM Hassan\033[1;91m: \031[1;91▒▓██████████████]99.9
\031[1;94mFacebook\033[1;91m: \031[1;91mlovehacker
\031[1;94mWhatsapp\031[1;91m: \031[1;91m+03183319095
\031[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mBlackMafia\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \031[1;96m....................M Hassan.....................:')
jalan("\031[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\031[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\031[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\031[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\031[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\031[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\031[1;96mLogin M Hassan\031[1;95m♡╰──────────•◈•──────────╯♡"

CorrectUsername = "Mhassan"
CorrectPassword = "DadLaghari"

loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;91m🔐 \x1b[1;91mTool Username \x1b[1;91m»» \x1b[1;93m")
    if (username == CorrectUsername):
    	password = raw_input("\031[1;94m🔐 \x1b[1;91mTool Password \x1b[1;91m»» \x1b[1;92m")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:M_Hassan
	    time.sleep(2)
            loop = 'false'
        else:
            print "\031[1;91mWrong Password"
            os.system('xdg-open https://m.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGnw')
    else:
        print "\031[1;94mWrong Username"
        os.system('xdg-open https://m.youtube.com/channel/UCRrRgcJjsnNm5Bi5ZenRGnw')
...
def login():
	...
	try:
		...
		os.system('clear')
		print logo
		jalan(' \031[1;92mWarning: \033[1;97mDo Not Use Your Personal Account' )
		jalan(' \031[1;92m   Note: \033[1;97mUse a New Account To Login' )
		print "\031[1;95m♡──────────•◈•──────────♡\033[1;96mMhassan\031[1;95m♡──────────•◈•──────────♡"
		print('	   \031[1;94m♡\x1b[1;91m》》》》》》LOGIN WITH FACEBOOK《《《《《《\x1b[1;94m♡' )
		print('	' )
		id = raw_input('\031[1;96m[+] \x1b[1;92mID/Email\x1b[1;95m: \x1b[1;96m')
		pwd = raw_input('\031[1;96m[+] \x1b[1;93mPassword\x1b[1;96m: \x1b[1;96m')
		tik()
		try:
...
def menu():
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mMuhammad Hassan\033[1;95m♡──────────•◈•──────────♡"
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mDadLaghari\033[1;95m♡──────────•◈•──────────♡"
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mM Hassan\033[1;95m♡──────────•◈•──────────♡"
	jalan(' \033[1;93m ........Cloning Start plzzz Wait.......... ')
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mDad Laghari\033[1;95m♡──────────•◈•──────────♡"
	...
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mM Hassan\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By love---•◈•---»" #Dev:love_Awais
	...
	print """
             ...
             ◥⊙▲⊙▲⊙▲⊙▲⊙▲⊙◤
♡──────────────•◈•──────────────♡.
: \033[1;96m .....M Hassan ❤love💖 Awais........... \033[1;93m :
♡──────────────•◈•──────────────♡.' 
                whatsapp Num
                 *03183319095"""
	
	raw_input("\n\031[1;92m[\031[1;94mhassan\031[1;96m]")
	menu()
